...
st.markdown("---")
st.markdown("<h3 style= 'color: red; text-align: center'>Audio Transcribe</h3>", unsafe_allow_html=True)
...
# col2.markdown("<h1 style='text-align: center; color: red; font-size: 10px; margin : 10px auto;'>[or]</h1>", unsafe_allow_html=True)
